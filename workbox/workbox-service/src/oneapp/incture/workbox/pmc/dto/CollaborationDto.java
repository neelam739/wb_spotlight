...
public String toString() {
	return "CollaborationDto [messageId=" + messageId + ", processId=" + processId + ", eventId=" + eventId
			+ ", userId=" + userId + ", userDisplayName=" + userDisplayName + ", createdAt=" + createdAt + ", message="
			+ message + ", chatId=" + chatId + ", chatDisplayName=" + chatDisplayName + ", messageDto=" + messageDto
