 ...
 */
@Stateless
public class WorkboxActionSLFacade implements WorkboxActionSLFacadeLocal {
...
//				Connection con = DBConnect.getDbCon().conn;
				...
				Query TEquery = em.getEntityManager().createNativeQuery(TEqueryString);
...
//				int update = preparedStatement.executeUpdate();
				...
				Query TOquery = em.getEntityManager().createNativeQuery(TOqueryString);
